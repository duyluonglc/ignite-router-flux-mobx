...
class MessageBar extends Component {
  ...
  getStateByProps (props) {
    return {
      ...
      durationToShow: props.durationToShow !== undefined ? props.durationToShow : 350,
      durationToHide: props.durationToHide !== undefined ? props.durationToHide : 350,
      ...
      messageBarPadding: props.messageBarPadding !== undefined ? props.messageBarPadding : 10,
  ...
  */
  _applyAnimationTypeTransformation () {
    ...
    switch (animationType) {
      case 'SlideFromTop':
        var animationYTop = this.animatedValue.interpolate({
          inputRange: [0, 1],
          outputRange: [-windowHeight, 0]
        })
        this.animationTypeTransform = [{ translateY: animationYTop }]
        break
      case 'SlideFromBottom':
        var animationYBottom = this.animatedValue.interpolate({
          inputRange: [0, 1],
          outputRange: [windowHeight, 0]
        })
        this.animationTypeTransform = [{ translateY: animationYBottom }]
        break
      case 'SlideFromLeft':
        var animationXLeft = this.animatedValue.interpolate({
          inputRange: [0, 1],
          outputRange: [-windowWidth, 0]
        })
        this.animationTypeTransform = [{ translateX: animationXLeft }]
        break
      case 'SlideFromRight':
        var animationXRight = this.animatedValue.interpolate({
          inputRange: [0, 1],
          outputRange: [windowWidth, 0]
        })
        this.animationTypeTransform = [{ translateX: animationXRight }]
        break
      default:
